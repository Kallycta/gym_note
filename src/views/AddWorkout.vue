...
const emit = defineEmits<{
  (e: 'open-exercise-list', category: string): void
}>()
...
<!-- Chest icon -->
<svg v-if="group.iconId === 'chest'" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 512 512" preserveAspectRatio="xMidYMid meet">
<g transform="translate(0,512) scale(0.1,-0.1)" stroke="none">
<path d="M1945 4695c-19-18-25-35-25-70 0-69-28-191-61-263-120-265-392-455-1026-716-264-110-315-139-417-247-148-155-236-367-266-643-6-54-22-137-36-183-29-102-67-314-91-513-32-270-21-792 18-892 22-54 103-61 135-12 15 22 16 36 5 122-46 370-6 911 97 1293 11 41 25 120 32 175 30 263 137 490 282 601 68 52 94 65 339 167 554 229 812 394 984 628 103 139 165 319 165 481 0 59-31 97-80 97-19 0-40-9-55-25z"/>
<path d="M3065 4695c-28-28-32-74-15-185 43-269 206-489 509-687 126-83 347-192 613-302 259-107 299-127 365-180 86-68 175-209 221-351 29-87 39-138 52-250 6-52 24-142 40-200 32-115 61-282 86-490 22-176 25-600 5-757-12-102-12-115 3-138 32-48 113-41 135 13 39 100 50 621 18 892-24 198-62 411-91 513-14 47-30 131-36 187-20 185-77 364-162 508-18 31-73 98-123 148-105 105-139 124-430 244-599 245-876 441-994 702-33 72-61 194-61 263 0 57-32 95-80 95-19 0-40-9-55-25z"/>
<path d="M1705 3735c-34-33-32-67 10-154 65-135 191-235 350-276 33-9 108-19 167-22l107-6 30 31c38 37 40 74 6 107-22 22-32 25-104 25-210 0-351 78-422 236-16 35-38 68-48 74-33 17-71 11-96-15z"/>
<path d="M3313 3745c-12-8-29-38-38-65-23-69-100-152-178-190-75-36-143-50-253-50-77 0-84-2-103-26-39-50-23-94 44-120 105-40 326 7 453 96 103 73 202 215 202 293 0 60-77 97-127 62z"/>
<path d="M2505 3095l-25-24 0-271 0-271 25-24c15-16 36-25 55-25 19 0 40 9 55 25l25 24 0 271 0 271-25 24c-15 16-36 25-55 25-19 0-40-9-55-25z"/>
</g>
</svg>
<!-- Arms icon -->
<svg v-else-if="group.iconId === 'arms'" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
<path d="M12.409 13.017A5 5 0 0 1 22 15c0 3.866-4 7-9 7-4.077 0-8.153-.82-10.371-2.462-.426-.316-.631-.832-.62-1.362C2.118 12.723 2.627 2 10 2a3 3 0 0 1 3 3 2 2 0 0 1-2 2c-1.105 0-1.64-.444-2-1"/>
<path d="M15 14a5 5 0 0 0-7.584 2"/>
<path d="M9.964 6.825C8.019 7.977 9.5 13 8 15"/>
</svg>
<!-- Back icon -->
<svg v-else-if="group.iconId === 'back'" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
<path d="M8 6h8"/><path d="M8 10h8"/><path d="M8 14h8"/><path d="M6 18h12"/>
</svg>
<!-- Legs icon -->
<svg v-else-if="group.iconId === 'legs'" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
<path d="M12 4v14"/><path d="M8 12c2-2 4-2 4-2s2 0 4 2"/><path d="M8 16c2 2 4 2 4 2s2 0 4-2"/>
</svg>
<!-- Shoulders icon -->
<svg v-else-if="group.iconId === 'shoulders'" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
<path d="M4 12c4-6 6-6 8-6s4 0 8 6"/><path d="M12 6v10"/>
</svg>
<!-- Core icon -->
<svg v-else-if="group.iconId === 'core'" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
<path d="M4 6h16v12H4z"/><path d="M12 2v4"/><path d="M12 18v4"/>
</svg>
<!-- Fullbody icon -->
<svg v-else-if="group.iconId === 'fullbody'" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
<circle cx="12" cy="5" r="3"/><path d="M6 11l2 3 3-1 1 5-2 5h4l2-5 1-5 3 1 2-3"/>
</svg>
...
.list-item:active { background: #f0f1f3; }
